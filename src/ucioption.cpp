...
void init(OptionsMap& o) {
  ...
  o["Contempt Factor"]             = Option(0, -50,  100);
  o["Mobility (Midgame)"]          = Option(100, 0, 400, on_eval);
  o["Mobility (Endgame)"]          = Option(100, 0, 300, on_eval);
  o["Pawn Structure (Midgame)"]    = Option(100, 0, 200, on_eval);
  o["Pawn Structure (Endgame)"]    = Option(100, 0, 200, on_eval);
  o["Passed Pawns (Midgame)"]      = Option(100, 0, 300, on_eval);
  o["Passed Pawns (Endgame)"]      = Option(100, 0, 300, on_eval);
  o["Space"]                       = Option(100, 0, 400, on_eval);
  o["Aggressiveness"]              = Option(100, 0, 500, on_eval);
